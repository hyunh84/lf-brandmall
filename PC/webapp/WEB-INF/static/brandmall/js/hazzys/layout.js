var headerFn = function(target, lang, subDepth) {
	...
	if(lang == 'en') {
		...
		html += '<h1 class="logo"><a href="#"><em>HAZZYS</em></a></h1>';
		html += '<div class="gnbWrap">';
		html += '<div class="gnbInner">';
		html += '<div class="gnbBox">';
		html += '<ul>';
		html += '<li>';
		html += '<a href="#">HOME</a>';
		html += '</li>';
		...
		html += '<li><a href="#"><span>여행가방</span></a></li>';
		...
		html += '<ul>';
		html += '<li>';
		html += '<a href="#">Collection</a>';
		html += '<div class="depth02">';
		html += '<ul>';
		html += '<li><a href="#"><span>남성 컬렉션</span></a></li>';
		html += '<li><a href="#"><span>여성 컬렉션</span></a></li>';
		html += '<li><a href="#"><span>액세서리 컬렉션</span></a></li>';
		html += '<li><a href="#"><span>골프 컬렉션</span></a></li>';
		html += '</ul>';
		html += '</div>';
		html += '</li>';
		html += '<li>';
		...
		html += '<a href="#">LOGIN</a>';
		html += '<a href="#">JOIN</a>';
		html += '<a href="#" class="btn_cart"><em>장바구니</em><span>0</span></a>';
		html += '</span>';
		html += '</div>';
	}
...
var footerFn = function(target, lang, subDepth) {
	...
	if(lang == 'en') {
		...
		html += '<button type="button"><span>KOREAN</span></button>';
		html += '<ul>';
		...
		html += '</div>';
		html += '<div class="familySelect">';
		html += '<button type="button"><span>FAMILY SITE</span></button>';
		html += '<ul>';
