var headerFn = function(target) {
	var html = '<h1 class="logo"><a href="#"><em>DAKS</em></a></h1>';
...
var createGnbFn = function(target) {
	...
	html += '<ul>';
	html += '<li class="foldSub"><a href="#">BRAND</a>';
	...
	html += '</li>';
	html += '<li>';
	html += '<a href="#">RUNWAY</a>';
	html += '</li>';
	html += '<li>';
	html += '<a href="#">GLOBAL DAKS</a>';
	html += '</li>';
	html += '</ul>';
	html += '</div>';
	html += '</li>';
	...
	html += '</li>';
	html += '<li>';
	html += '<a href="#">DAKS ICONIC ITEM</a>';
	html += '</li>';
	html += '</ul>';
	html += '<button type="button" class="btnGnbPrev"><em>이전</em></button>';
	html += '<button type="button" class="btnGnbClose"><em>닫기</em></button>';
	html += '</div>';
	html += '</li>';
	html += '<li><a href="#">GIFT</a>';
	html += '<div class="subGnb">';
	html += '<strong>GIFT</strong>';
	html += '<ul>';
	html += '<li>';
	html += '<a href="#"><span>GIFT</span>\'S HOME</a>';
	html += '</li>';
	html += '<li>';
	html += '<a href="#">남성 선물</a>';
	html += '</li>';
